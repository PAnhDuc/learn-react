...
// import HomeHeaderBar from "../components/HomeComponent/HomeHeaderBar";
import './HomePage.css'
...
export default function HomePage() {
  ...
  {title:"Triết lí giáo dục", content:"Lãnh đạo - Nhân văn - Chính trực"}]
  return <>
  ...
  <div className='me-3 cursor-pointer'>Cán bộ 7 Giảng viên</div>
  ...
  <section>
    <div className='container d-flex align-items-center py-4'>
      <img src="https://lhu.edu.vn/ViewPage/LHUVNB4/_default/image/Logo_yellow.png" alt="" height={40}/>
